...
import { z } from "zod";
import { CodeWriterAgent } from "./code-writer";
import { SecurityAuditAgent } from "./security-audit";
import { LintingAgent } from "./linting";
import { FunctionalityAgent } from "./functionality";
...
export class CoordinatorAgent {
  ...
  constructor(models: {
    ...
    this.agent = new Agent({
      ...
      model: models.coordinator || "claude-3-5-sonnet-20241022",
    });
